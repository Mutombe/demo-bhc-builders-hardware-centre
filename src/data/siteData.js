...
const siteData = {
  business: {
    name: "BHc Builders Hardware Centre",
    legalName: "BHc Builders Hardware Centre",
    tagline: "Quality Building Materials & Hardware Supplies",
    description: "BHc Builders Hardware Centre has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
    phone: "+263 77 223 1349",
    phoneRaw: "+263772231349",
    whatsappNumber: "263772231349",
    email: "info@bhcbuildershardwarec.co.zw",
    address: "Rezende St, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 3.8,
    ratingRounded: 4,
    ...
    cookieConsentKey: "bhc-builders-hardware-centre-cookie-consent",
    socialLinks: { facebook: "https://www.facebook.com/bhchardwarecentre/videos/bi-fold-barn-door-sliding-system-90/555712260948915/", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "BHc", logoLine2: "Builders Hardware" },
  ...
  hero: {
    ...
    trustBadge: "330+ Customer Reviews",
    backgroundImages: [
  ...
  stats: [
    { number: "330+", label: "Customer Reviews" },
  ...
  homeTestimonials: [
    { text: "BHc Builders Hardware Centre has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    ...
    { text: "Bulk delivery is always on time and the prices are competitive. BHc Builders Hardware Centre is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "BHc Builders Hardware Centre has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
  ...
  reviews: {
    ...
    items: [
      { text: "BHc Builders Hardware Centre has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5 },
      ...
      { text: "Bulk delivery is always on time and the prices are competitive. BHc Builders Hardware Centre is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. BHc Builders Hardware Centre exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend BHc Builders Hardware Centre to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at BHc Builders Hardware Centre is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. BHc Builders Hardware Centre has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi BHc Builders Hardware Centre! I would like to request a quote.",
